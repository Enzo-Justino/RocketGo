...
if (window.location.pathname.includes("dados.html")) {
  ...
  if (!usuario || logado !== "true") {
    ...
    perfil.innerHTML = `
      ...
      <div class="info-item"><strong>Área de Interesse:</strong> <span>${usuario.areaInteresse}</span></div>
    `;
    ...
    if (usuario.exame) {
      perfil.innerHTML += `
        <div class="info-item"><strong>Exame Médico:</strong>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const cursos = [
    { titulo: "Meowth", modalidade: "Preço: R$ 150,00", local: "Cidade de Vermelho", resumo: "Foi capturado com uma isca de peixe e um golpe rápido de distração.", video: "", material: "material/meowth.pdf", arquivos: "arquivos/meowth.zip", horas: "Previsão de entrega: 18h30" },
    { titulo: "Ekans", modalidade: "Preço: R$ 180,00", local: "Pinwheel Forest", resumo: "Foi capturado após ser atraído por um saco de comida e preso em uma rede.", video: "", material: "material/ekans.pdf", arquivos: "", horas: "Previsão de entrega: 19h15" },
    { titulo: "Koffing", modalidade: "Preço: R$ 210,00", local: "Caverna do Poço", resumo: "Foi capturado quando a equipe o encurralou com fumaça e uma armadilha de metal.", video: "", material: "material/koffing.pdf", arquivos: "arquivos/koffing.zip", horas: "Previsão de entrega: 17h45" },
    { titulo: "Arbok", modalidade: "Preço: R$ 260,00", local: "Floresta de Viridian", resumo: "Foi capturado após uma perseguição em terreno fechado e uso de uma gaiola.", video: "", material: "material/arbok.pdf", arquivos: "", horas: "Previsão de entrega: 20h00" },
    { titulo: "Persian", modalidade: "Preço: R$ 320,00", local: "Rua de Celadon", resumo: "Foi capturado com uma distração de comida e um movimento de cercamento.", video: "", material: "material/persian.pdf", arquivos: "", horas: "Previsão de entrega: 21h10" },
    { titulo: "Pikachu", modalidade: "Preço: R$ 420,00", local: "Laboratório de Silph", resumo: "Foi capturado por eletricidade contida e um laço controlado de alta precisão.", video: "", material: "material/pikachu.pdf", arquivos: "", horas: "Previsão de entrega: 16h20" },
    { titulo: "Magikarp", modalidade: "Preço: R$ 120,00", local: "Lago de Johto", resumo: "Foi capturado com um anzol reforçado e muita paciência na margem do lago.", video: "", material: "material/magikarp.pdf", arquivos: "", horas: "Previsão de entrega: 15h45" },
    { titulo: "Weezing", modalidade: "Preço: R$ 280,00", local: "Desfiladeiro de Kanto", resumo: "Foi capturado após ser envolvido por gás de distração e encurralado em terreno estreito.", video: "", material: "material/weezing.pdf", arquivos: "", horas: "Previsão de entrega: 22h00" },
    { titulo: "Mankey", modalidade: "Preço: R$ 170,00", local: "Morro da Montanha", resumo: "Foi capturado em uma corrida leve usando uma rede e uma distração sonora.", video: "", material: "material/mankey.pdf", arquivos: "", horas: "Previsão de entrega: 18h05" },
    { titulo: "Nidoking", modalidade: "Preço: R$ 390,00", local: "Caverna de Ouro", resumo: "Foi capturado depois de uma investida em terreno acidentado, com armadilha de ferro.", video: "", material: "material/nidoking.pdf", arquivos: "", horas: "Previsão de entrega: 19h40" },
    { titulo: "Nidoqueen", modalidade: "Preço: R$ 360,00", local: "Vale de Granite", resumo: "Foi capturado em uma emboscada de baixa altura e contido com cordas reforçadas.", video: "", material: "material/nidoqueen.pdf", arquivos: "", horas: "Previsão de entrega: 17h15" },
    { titulo: "Snorlax", modalidade: "Preço: R$ 500,00", local: "Trilha de Vermilion", resumo: "Foi capturado depois de dormir em um ponto de emboscada e ser levado sem resistência.", video: "", material: "material/snorlax.pdf", arquivos: "", horas: "Previsão de entrega: 23h00" },
    { titulo: "Zubat", modalidade: "Preço: R$ 140,00", local: "Toca das Trevas", resumo: "Foi capturado em voo baixo usando redes de seda e um sinal de distração.", video: "", material: "material/zubat.pdf", arquivos: "", horas: "Previsão de entrega: 14h50" },
    { titulo: "Muk", modalidade: "Preço: R$ 330,00", local: "Riacho de Fumaça", resumo: "Foi capturado quando o grupo o isolou em uma área estreita e o prendeu com uma bolsa.", video: "", material: "material/muk.pdf", arquivos: "", horas: "Previsão de entrega: 20h30" },
    { titulo: "Pidgeot", modalidade: "Preço: R$ 290,00", local: "Pico da Águia", resumo: "Foi capturado em pleno voo após ser encurralado e amarrado por uma linha de captura.", video: "", material: "material/pidgeot.pdf", arquivos: "", horas: "Previsão de entrega: 18h55" },
    { titulo: "Gastly", modalidade: "Preço: R$ 240,00", local: "Cemitério de Saffron", resumo: "Foi capturado na escuridão, com uma armadilha de luz e um brilho de distração.", video: "", material: "material/gastly.pdf", arquivos: "", horas: "Previsão de entrega: 21h25" },
  ];
  ...
  function renderCursos(lista) {
    ...
    lista.forEach(curso => {
      ...
      card.className = "curso-card";
      card.innerHTML = `
        <div class="curso-imagem" aria-label="Imagem do Pokémon ${curso.titulo}">
          <span>Imagem do Pokémon</span>
        </div>
        <h3>${curso.titulo}</h3>
        <div class="curso-detalhes hidden">
